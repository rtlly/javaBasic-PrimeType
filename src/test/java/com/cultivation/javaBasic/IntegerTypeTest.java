...
class IntegerTypeTest {
    ...
    void should_truncate_number_when_casting() {
        ...
        // TODO: please modify the following lines to pass the test
        // <!--start
        String integerIn2 = Integer.toBinaryString(integer);
        final short expected = Short.valueOf("0100010101100111", 2);
        // --end-->
    ...
    private int add(int left, int right) {
        ...
        if ((left == Integer.MAX_VALUE && right >= 1) || (right == Integer.MAX_VALUE && left >= 1)) {
